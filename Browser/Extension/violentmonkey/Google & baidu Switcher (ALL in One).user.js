      ...
      ~(async function setSearchEngineConfig(checkAutoUpdate, fetchRemoteIcon, getResultFilterData) {
        ...
        const listSite = {
          ...
          google: {
            ...
            WebURL: "https://www.google.com/search?hl=en&safe=off&gl=us&pws=0&q=",
          ...
          bing: {
            ...
            WebURL: "https://www.bing.com/search?safesearch=off&hta=off&rdr=1&setmkt=en-us&setlang=en-us&q=",
          ...
          brave: {
            ...
            WebURL: "https://search.brave.com/search?safesearch=off&country=all&q=%",
